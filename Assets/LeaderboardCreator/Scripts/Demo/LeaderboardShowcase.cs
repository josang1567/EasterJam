...
namespace Dan.Demo
{
    public class LeaderboardShowcase : MonoBehaviour
    {
        ...
        public void Load()
        {
            ...
            Leaderboards.EggHuntTime.GetEntries(searchQuery, OnLeaderboardLoaded, ErrorCallback);
        ...
        private void Start()
        {
            if (PlayerPrefs.HasKey("finalPoints") == true)
            {
                _playerScore = PlayerPrefs.GetInt("finalPoints");
            }
            else
            {
                _playerScore = 0;
            }
            _playerScoreText.text = $"Points: {_playerScore}";
        ...
        public void Submit()
        {
            ...
            lm.SetLeaderboardEntry( Leaderboards.EggHuntTime.PublicKey,_playerUsernameInput.text, _playerScore, PlayerPrefs.GetString("TimeLeft"));
        }
        
        public void DeleteEntry()
        {
            Leaderboards.EggHuntTime.DeleteEntry(Callback, ErrorCallback);
        }
        ...
        {
            Leaderboards.EggHuntTime.GetPersonalEntry(OnPersonalEntryLoaded, ErrorCallback);
        }
